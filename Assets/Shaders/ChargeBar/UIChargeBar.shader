Shader "UI/UIChargeBar"
{
    Properties
    {
        ...
        _MaxGlow ("Max Glow", Float) = 1.5
        _MaxGlowColor ("Max Glow Color", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target {
                ...
                if (!isDivisor)
                {
                    glow = lerp(1, _MaxGlow, IN.texcoord.x);
                    color = lerp(color, _MaxGlowColor, IN.texcoord.x);
                }
                color = color * glow;
