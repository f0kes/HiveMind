...
namespace UI
{
	...
	public class DamageFill : MonoBehaviour
	{
		...
		[SerializeField][ColorUsage(true,true)] private Color _targetColor = new Color(0f, 0f, 0f, 0f);
		...
		{
			return Mathf.Clamp01(t * t * (3.0f - 2.0f * t));
		}
		private void Update()
		{
			...
			{
				var blend = BezierBlend(_timer / _fadeTime);
